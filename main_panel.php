<div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">Welcome back,  <?php echo $_SESSION['tipe_user']; ?></h4>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="../../assets/template/spica/template/images/faces/face1.jpg" alt="image"/>
                          </td>
                          <td>
                            Herman Beck
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../../assets/template/spica/template/images/faces/face2.jpg" alt="image"/>
                          </td>
                          <td>
                            Messsy Adam
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../../assets/template/spica/template/images/faces/face3.jpg" alt="image"/>
                          </td>
                          <td>
                            John Richards
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../../assets/template/spica/template/images/faces/face4.jpg" alt="image"/>
                          </td>
                          <td>
                            Peter Meggik
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../../assets/template/spica/template/images/faces/face5.jpg" alt="image"/>
                          </td>
                          <td>
                            Edward
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../../assets/template/spica/template/images/faces/face6.jpg" alt="image"/>
                          </td>
                          <td>
                            John Doe
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="../../assets/template/spica/template/images/faces/face7.jpg" alt="image"/>
                          </td>
                          <td>
                            Henry Tom
                          </td>
