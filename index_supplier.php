...
<head>
    ...
    <title>
        Halaman <?php echo $_SESSION['tipe_user']; ?>
    </title>

    <!-- CSS -->
    <link rel="stylesheet"
        href="../../assets/template/spica/template/vendors/mdi/css/materialdesignicons.min.css">

    <link rel="stylesheet"
        href="../../assets/template/spica/template/vendors/css/vendor.bundle.base.css">

    <link rel="stylesheet"
        href="../../assets/template/spica/template/css/style.css">

    <link rel="shortcut icon"
        href="../../assets/template/spica/template/images/favicon.png" />
...
<body>
    ...
    <script src="../../assets/template/spica/template/js/jquery.cookie.js"></script>
